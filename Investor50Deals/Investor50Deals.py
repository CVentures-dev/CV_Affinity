...
def main():
    ...
    #### IF IT DOES 
        if organizations:
            ...
            fill_all_fields(org_id, list_entry_id, companyHQ, eurRaising, pitchdeck, industrySector, companyStage, first_name, name, email)
    ...
    #### IF IT DOESN'T
            ...
            fill_all_fields(organisation_id, list_entry_id, companyHQ, eurRaising, pitchdeck, industrySector, companyStage, first_name, name, email)
